...
amp_pitch=0.17;
amp_heave=1;
freq_pitch=100; %rad/s
freq_heave=100; %rad/s
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
alp=0.1;
alp_dot=0.0;
x=[heave_disp heave_vel alp alp_dot];
...
for k=0:p
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    parameters(2)=amp_pitch*sin(freq_pitch*k*delta_t)+alp;
    parameters(3)=freq_pitch*(amp_pitch)*cos(freq_pitch*k*delta_t)+alp_dot;
    parameters(5)=k;
...
Moment(i,1)=-sum(delta_p1.*bound_vort_coord_rel(1:end-1,1));
temp_lift=Lift(i,1);
